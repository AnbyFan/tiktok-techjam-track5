#!/usr/bin/env python3
"""
Robustness evaluation harness WITHOUT noise transforms (Track 5).

Skips noise transforms that cause hangs on this system.
"""
...
def build_specs():
    """Build transform specs WITHOUT noise transforms."""
    specs = [("clean", "clean", {})]
